			...
			try {
				...
				if (msg.type.equals("message")) {
					if (msg.recipient.equals(ui.username)) {
						ui.messageArea.append("[" + msg.sender + " > Me] : "
								+ msg.content + "\n");
					} else {
						ui.messageArea.append("[" + msg.sender + " > "
					...
					if (!msg.content.equals(".bye")
						...
						try {
							...
							DefaultTableModel table = (DefaultTableModel) ui.historyFrame.jTable1
									.getModel();
							table.addRow(new Object[] { msg.sender,
									msg.content, "Me", msgTime });
						} catch (Exception ex) {
						}
					}
					...
					if (msg.content.equals("TRUE")) {
						...
						ui.fileBrowseButton.setEnabled(true);
						ui.messageArea
								.append("[SERVER > Me] : Login Successful\n");
						ui.userNameField.setEnabled(false);
						ui.passwordField.setEnabled(false);
					} else {
						ui.messageArea.append("[SERVER > Me] : Login Failed\n");
					}
					...
					ui.userNameField.setEnabled(false);
					ui.passwordField.setEnabled(false);
					ui.hostNameField.setEditable(false);
					ui.portField.setEditable(false);
					ui.historyfileBrowseButton.setEnabled(true);
					...
					if (msg.content.equals("TRUE")) {
						...
						ui.messageArea
								.append("[SERVER > Me] : Signup Failed\n");
					}
					...
					if (msg.content.equals(ui.username)) {
						...
						ui.hostNameField.setEditable(true);
						...
						ui.messageArea.append("[" + msg.sender + " > All] : "
					...
					if (!msg.content.equals("NO")) {
						...
						ui.fileBrowseButton.setEnabled(false);
						...
						ui.messageArea.append("[SERVER > Me] : " + msg.sender
		...
		try {
			...
			if (msg.type.equals("message") && !msg.content.equals(".bye")) {
				...
				try {
					...
					DefaultTableModel table = (DefaultTableModel) ui.historyFrame.jTable1
							.getModel();
					table.addRow(new Object[] { "Me", msg.content,
							msg.recipient, msgTime });
				} catch (Exception ex) {
				}
			}
