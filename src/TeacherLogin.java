...
public class TeacherLogin extends javax.swing.JFrame {
	...
	public TeacherLogin(String ipAddr) {
		this.ipAddr = ipAddr;
		initComponents();
		invalidLabel.setVisible(false);
	}
	...
	private void initComponents() {
		...
		teacherLoginLabel.setFont(new Font("Calibri", 0, 36));
		teacherLoginLabel.setText("Hello !!!");
	...
	private void signinButtonActionPerformed(ActionEvent e) {
		TeacherElements a = new TeacherElements(" ", " ", " ", " ",
				userIDField.getText(), passwordField.getText(), " ");
		try {
			Socket clientsocket = new Socket(getglobal(), 12345);
			PrintWriter pw = new PrintWriter(clientsocket.getOutputStream());
			pw.println("teacherlogin");
			pw.flush();
			Socket newclientsocket = new Socket(getglobal(), 30012);
			...
			if (feedback.equals("Right")) {
				TeacherInfo p = new TeacherInfo(userIDField.getText());
	...
	private void signUpButtonActionPerformed(ActionEvent e) {
		TeacherRegistry a = new TeacherRegistry(ipAddr);
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(TeacherLogin.class.getName())
	...
	private JLabel teacherLoginLabel;
